...
// import invoiceData from "./DummyInvoice";
      ...
      >
        <div className="border-[2px] border-black p-5 h-auto relative">
            ...
            <table className="w-full mb-5 text-sm border-collapse border border-gray-300">
              <tbody>
                ...
                <tr>
                  ...
                  <td className="border border-gray-300 p-2">
                    <strong>Model Code:</strong> {invoiceData.modelCode}
                  </td>
                </tr>
                <tr>
                  <td className="border border-gray-300 p-2">
                ...
                <tr>
                  <td className="border border-gray-300 p-2">
                    <strong>Model Name:</strong> {invoiceData.modelName}
                  </td>
                  <td className="border border-gray-300 p-2">
                    <strong>Job Card Date:</strong> {invoiceData.jobCardDate}
                  </td>
                </tr>
                <tr>
                  <td className="border border-gray-300 p-2">
                    <strong>Odometer Reading:</strong>{" "}
                    {invoiceData.odometerReading}
                  </td>
                  <td className="border border-gray-300 p-2">
                ...
                <tr>
                  ...
                  <td className="border border-gray-300 p-2">
                    <strong>Service Centre:</strong> {invoiceData.serviceCentre}
                  </td>
                </tr>
                <tr>
                  <td className="border border-gray-300 p-2">
                    <strong>Engine Number:</strong> {invoiceData.engineNumber}
                  </td>
                  <td className="border border-gray-300 p-2">
                    <strong>Company GSTIN:</strong> {invoiceData.supplierGSTIN}
                  </td>
                </tr>
                <tr>
                  <td className="border border-gray-300 p-2">
                    <strong>Chassis Number:</strong> {invoiceData.chassisNumber}
                  </td>
                  <td className="border border-gray-300 p-2">
                    <strong>Customer Voice:</strong> {invoiceData.customerVoice}
                  </td>
                </tr>
              </tbody>
            </table>
          ...
          <table className="w-full text-sm border-collapse border border-gray-300 mb-5">
            ...
            <tbody>
              {invoiceData.labour.map((labour, index) => (
                <tr key={index}>
