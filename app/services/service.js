...
export const fetchAllServices = async (
  ...
  try {
    const response = await axios.get(
      `${process.env.NEXT_PUBLIC_ADMIN_BACKEND}/app/fetchAllBookings`,
      {
        params: {
          page,
          limit,
...
export const fetchAllGarages = async () => {
  try {
    const response = await axios.get(
      `${process.env.NEXT_PUBLIC_LOGIN_URL}/address/getAllGarages`,
      {
        headers: {
          accept: "application/json",
          Authorization: `Bearer ${accessToken}`,
...
export const fetchServiceDetailsById = async (serviceId) => {
  try {
    const response = await axios.get(
      `${process.env.NEXT_PUBLIC_ADMIN_BACKEND}/app/fetchServiceById?serviceId=${serviceId}`,
      {
        headers: {
          accept: "application/json",
          Authorization: `Bearer ${accessToken}`,
...
export const fileUpload = async (formData) => {
  try {
    const response = await axios.post(
      `${process.env.NEXT_PUBLIC_ADMIN_BACKEND}/service/uploadDocuments`,
      formData,
      {
        headers: {
...
export const generateJobsheetPdf = async (payload) => {
  try {
    const response = await axios.post(
      `${process.env.NEXT_PUBLIC_ADMIN_BACKEND}/service/generatePdf`,
      payload,
      {
        headers: {
